interface EmailTemplateProps {
  ...
  export const generateEmailHTML = ({ appointment, user, stylist }: EmailTemplateProps & { stylist: { name: string } }) => {
              ...
              <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden;">
                ...
                <tr>
                  <td style="background-color: #000000; padding: 20px; text-align: center;">
                    <img src="https://yourwebsite.com/logo.svg" alt="Choppers Salon" style="max-width: 150px; height: auto;">
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding: 0 30px 30px; text-align: center;">
                    <a href="https://yourwebsite.com/appointments" style="display: inline-block; background-color: #fbb034; color: #ffffff; text-decoration: none; padding: 12px 30px; border-radius: 4px; font-weight: bold;">Manage Appointment</a>
                  </td>
                </tr>
